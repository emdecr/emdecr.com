...
INSERT INTO travels (id, name, country, lat, lng, date, date_end, images, record_slug, note) VALUES
  ('london-2024',   'London',   'England',       51.5074,   -0.1278,  '2024-03', '2024-04', '[]'::jsonb, NULL, 'Test pin — should land on southeast England'),
  ('tokyo-2024',    'Tokyo',    'Japan',          35.6762,  139.6503,  '2024-10',  NULL,      '[]'::jsonb, NULL, 'Test pin — should land on Honshu island'),
  ('new-york-2023', 'New York', 'United States',  40.7128,  -74.006,  '2023-06', '2023-06',  '[]'::jsonb, NULL, 'Test pin — should land on US northeast coast')
